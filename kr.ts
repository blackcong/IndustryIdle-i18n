export const KR = {
    ...
    KansasCity: "캔자스 시티",
    Dam: "수력 댐",
    DamDesc: "수력 댐은 인접한 빈 타일을 물 타일로 바꿉니다.",
    Farmland: "농지",
    FarmlandDesc: "물 타일 위에 작물을 심는다",
    Storage: "Storage",
    Rice: "쌀",
    Corn: "옥수수",
    Wheat: "밀",
    ...
    BatteryRecycler: "배터리 재활용 처리장",
    BatteryShell: "배터리(폐전지)",
    ...
    FrozenVegetable: "냉동 채소",
    MilkPowder: "분유",
    CannedFish: "통조림 생선",
    CocoaPowder: "코코아 가루",
    FrozenChicken: "냉동 닭고기",
    FrozenPork: "냉동 돼지고기",
    CannedBeef: "통조림 소고기",
    ...
    AchievementFishPond200: "양식장의 제독",
    AchievementFishPond200Desc: "하나의 지도에서 물고기 양식장 200개 만들기",
};
